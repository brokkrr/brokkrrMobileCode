$(document).on("pagebeforecreate","#businessInsurance_page", function (event) {
               if (strDevice!="iPad"){
...
$(document).on("pageshow","#businessInsurance_page", function( event,ui ) {
	 		...
	 		$.ajax({		
				...
				success: function (data) {	
					...
					if(issuccess==true)
					{
						...
						sessionStorage.setItem('SearchListtype',"General Liability");/*25May18*/
	 	 ...
	 	 else
	 	 {
	 		 ...
	 		 $('#InfopopupBusiness').popup('open');
               ...
               $('#OpenGallery').on("click", function () {
                                    ...
                                    getdocImages("fileInput","getfileconversion","InfopopupBusiness");
                                    });
               
               $('#OpenCamera').on("click", function () {
                                   $('#ConfirmPictureInfopopup').popup('close');
                                   getdocImagescamera("fileInput","getfileconversion","InfopopupBusiness");
                                   });
