$(document).on("pageshow","#autoInsurance_page,#autoInsuranceNext_page", function( event ) {
...
$('#GotohomeInsurancePage').off("click").on("click", function() {
    $.mobile.loading("show");
    $( ":mobile-pagecontainer" ).pagecontainer( "change", "../customer/homeInsurance.html",{transition: "slide",reverse: false});
...
/*01 Jan 2018*/
		...
		if(validatezip())
		 {
			    var ZipCode=$('#zipcode').val();
	 	 		...
	 	 		$.mobile.loading("hide");
	 	 		$( ":mobile-pagecontainer" ).pagecontainer( "change", "../customer/autoInsuranceNext.html",{transition: "slide",reverse: false});
		 }
		 else
	 	 {
	 		 $.mobile.loading("hide");
	...
	$('#saveAutoInsurance').off("click").on("click", function() {
		...
		function validateFields(){
	 		if (/* 01 Jan 2018 globalvalidaterequired7(IsInsured,Company,divHometype) & globalvalidaterequired5(CoverageExpires1,divCoverage) &*/ globalvalidaterequired6(IsInsured,divHometype) & globalvalidaterequired6(Language1,divLanguage))
	 		{
	         	return true;
	        }
	         else
