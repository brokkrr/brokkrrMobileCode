$(document).on("pagebeforecreate","#personallinebenefits_page", function (event) {
               if (strDevice!="iPad"){
...
$(document).on("pageshow","#personallinebenefits_page", function( event,ui ) {
...
$('.ui-content').css('height',hbcontent);*/
	...
	$('#psaveBenefitsInsurance').off("click").on("click", function() {
	    $.mobile.loading("show");
...
function pCountSicCodeBenefits()
{
     if (strDevice=="iPad"){
